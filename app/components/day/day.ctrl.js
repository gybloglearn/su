(function () {
  ...
  DayController.$inject = ['$state', '$cookies', '$rootScope', '$filter', '$mdSidenav', 'ShiftreportsService', 'ModulListService', 'SmplansService'];
  function DayController($state, $cookies, $rootScope, $filter, $mdSidenav, ShiftreportsService, ModulListService, SmplansService) {
    var vm = this;
