...
define("REPORT", "/MCS_ZW1K/ZW1500 D FG Scrap Data");
...
$startdate = date("m/d/Y H:i:s", strtotime($_GET["startdate"] . " 00:00:00"));
if(isset($_GET["enddate"])){
  $enddate = date("m/d/Y H:i:s", strtotime($_GET["enddate"] . " 00:00:00"));
} else {
  $enddate = date("m/d/Y H:i:s", strtotime($_GET["startdate"]." 00:00:00") + 60*60*24);
}

// define categories
$categ=Array("nap"=>2,"hét"=>1,"hónap"=>0);
